...
1. Keep Amihud in the Cross candidate ledger after H-XSEC-S5-001's rough implementation pass; do not register it in production unless a separately approved test measures real friction and addresses the unusually large survivor-conditioned result. The 775/775 `stage-2` dual-basis receipt gate through the fixed `2026-08-27` ET cutoff is complete; historical PIT membership remains parked without blocking disposable research.
