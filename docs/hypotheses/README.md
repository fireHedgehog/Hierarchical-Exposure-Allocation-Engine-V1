...
| [Asset selection research](asset-selection-research/README.md) (subfolder) | cross-sectional selection framework, own index | in progress | Which sector/asset-class/theme to hold. First paper run: H-SECT01 (section leadership persistence) — rejected at a rigorous quarterly test after catching a mechanical confound in the first, weaker test. | n/a |
