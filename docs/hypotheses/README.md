...
| [Asset selection research](asset-selection-research/README.md) (subfolder) | 13-asset real sleeve universe (GLD-anchored), own index | in progress | H-SECT01 (leadership persistence): rejected, chance-level at a quarterly test. H-SECT02 (regime-conditioned relative return): confirmed in-sample, 11/24 sleeve/window tests significant, economically coherent — no OOS split yet. | n/a |
