...
| [Asset selection research](asset-selection-research/README.md) (subfolder) | cross-sectional selection framework, own index | in progress | Which sector/asset-class/theme to hold. First paper designed: H-SECT01 (section leadership persistence, regime-conditional) — universe already confirmed real, not run yet. | n/a |
