# Research Hypotheses - Staging V1 Archive

> Historical experiments only. Start new work in
> [Staging V2](../../staging_v2/README.md). Do not expand this archive; Git is the
> longer-term history.
...
| [Short-term reversal cost robustness](short-term-reversal-cost-robustness.md) | historical walk-forward/cost attempt | invalidated 2026-08-30 | Same-row/different-date alignment and doubled-turnover bugs revoke every return/cost figure; H-XSEC-S2-004 restores relationship evidence only | Historical context only |
