...
| 2026-08-26 | Follow-up: real 12-1 (skip most recent month) specification, `research_lab/time_series_momentum.py`, same dataset -- direct test of whether the uniform-reversal result above was an artifact of blending a genuine short-term-reversal effect into the 12m window and swamping a real medium-term continuation effect underneath it (Jegadeesh & Titman's 1993 documented reason for the 12-1 spec; a real, correctly-motivated methodological question, not answered by assumption) | **Still rejected.** 12m_skip1m: r=-0.028 (adjusted p=0.0066, n=9,317) -- smaller in magnitude than the raw 12m reading (r=-0.046) but still significant and still negative. Isolating the short-term reversal effect reduced, but did not reverse, the sign. | The methodological question itself was worth asking and checking, not dismissed -- it changed the honest magnitude of the finding, just not its conclusion. Reinforces, rather than overturns, this paper's core result: at the time-series (own-asset) level, this universe/window shows real reversal at every tested horizon, short and long, properly isolated or not -- a genuinely different answer than the same isolation technique gave cross_sectional_momentum's own 12-1 component (0.16), which found real continuation once isolated. |
| 2026-08-26 | Rerun on the real 2004-2026 dataset (post-0.38 extension, now including 2008), same script, same 5 horizons | **Rejected, replicated, but weaker.** 1m: r=-0.036, still significant. 3m: r=-0.013, no longer significant (was significant on 2016-26). 6m: r=-0.007, still not significant. 12m: r=-0.018, still significant but smaller. 12m_skip1m: r=-0.014, no longer significant (was r=-0.028, p=0.0066 on 2016-26). | Real, meaningful change: only 2 of 5 horizons remain significant on the longer window (was 5 of 5 on 2016-26). The reversal pattern is real but structurally weaker once 2008 is included -- consistent with, though not conclusive proof of, the standing explanation that this was partly a bull-decade-specific artifact rather than a universal property of this universe. |
