...
const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    codeReference: "backend/engine/factors/momentum.py",
    strategyKey: "cross_sectional_momentum",
    summary: "Real prices -> a blended momentum score, ranked against peers, rescaled to conviction.",
    steps: [
      ...
      { label: "Weighted blend", formula: "blend = 0.2*r_1m + 0.3*r_3m + 0.5*r_6m" },
    ...
    naiveParameters: "Horizon blend weights (0.2/0.3/0.5), the z-score divisor (2), and the x5 rescale are hand-picked. No IC, decay, or turnover evidence has been measured yet.",
  },
  {
